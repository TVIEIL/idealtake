...
Public Class Form_Diagnostic
    ...
    Private Sub Form1_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        argument_Diagnostic01.Nom_de_la_base_de_donnée = Nom_de_la_base
        argument_Diagnostic01.chaine_de_connexion = connexion
        argument_Diagnostic01.langue_logiciel = langue_logiciel
    ...
    Private Function Diagnostic_de_la_connexion(ByVal Argument As Argument_objet_Diagnostic)
        ...
        Infos_diagnostic = Infos_diagnostic & " " & Message_utilisateur(93, Argument.langue_logiciel) & " : " & Argument.Nom_Connexion & " - " & Date_Recherche & vbCrLf & vbCrLf
        If My.Computer.Network.IsAvailable Then

            'L'ordinateur est relié à un réseau local et/ou Internet
            Infos_diagnostic = Infos_diagnostic & " " & Message_utilisateur(94, Argument.langue_logiciel) & "." & vbCrLf


        Else
            'L'ordinateur n'est pas relié à un réseau local et/ou Internet
            Infos_diagnostic = Infos_diagnostic & " " & Message_utilisateur(95, Argument.langue_logiciel) & "." & vbCrLf
        ...
        Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(96, Argument.langue_logiciel) & " : " & nics.Length.ToString & vbCrLf

        For Each carte As NetworkInterface In nics

            'Carte Réseau
            Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & " " & Message_utilisateur(97, Argument.langue_logiciel) & " : " & carte.Id.ToString & "  -  " & carte.Name.ToString & vbCrLf

            'Infos_diagnostic = Infos_diagnostic & " " & " " & carte.GetIPProperties.ToString & vbCrLf

            'Description de la carte
            Infos_diagnostic = Infos_diagnostic & " " & " " & Message_utilisateur(98, Argument.langue_logiciel) & " : " & carte.Description.ToString & vbCrLf

            'Type d'interface
            Infos_diagnostic = Infos_diagnostic & " " & " " & Message_utilisateur(99, Argument.langue_logiciel) & " : " & carte.NetworkInterfaceType.ToString & vbCrLf

            'Vitesse
            Infos_diagnostic = Infos_diagnostic & " " & " " & Message_utilisateur(100, Argument.langue_logiciel) & " : " & (carte.Speed / 1000000).ToString & " Mbits/s" & vbCrLf

            'Etat
            Infos_diagnostic = Infos_diagnostic & " " & " " & Message_utilisateur(101, Argument.langue_logiciel) & " : " & carte.OperationalStatus.ToString.Replace("Up", "Actif") & vbCrLf
            ...
            If p1 Is Nothing Then
                ...
                Infos_diagnostic = Infos_diagnostic & " " & " " & Message_utilisateur(102, Argument.langue_logiciel) & "." & vbCrLf
                GoTo ContinueForEach1
            End If
...
ligne_11332:
            ...
            Infos_diagnostic = Infos_diagnostic & " " & " " & Message_utilisateur(104, Argument.langue_logiciel) & " : " & Octets_Envoyées & " octets" & vbCrLf

            Dim Octets_Réçues As String = ""
            Octets_Réçues = carte.GetIPv4Statistics.BytesReceived.ToString
            'Réception de données IPv4
            Infos_diagnostic = Infos_diagnostic & " " & " " & Message_utilisateur(105, Argument.langue_logiciel) & " : " & Octets_Réçues & " octets" & vbCrLf
        ...
        Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(106, Argument.langue_logiciel) & " : " & Environment.MachineName.ToString() & vbCrLf

        My.Settings.ProgressBar_Diagnostic += 1

        'Adresse(s) IP de cette machine
        Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(107, Argument.langue_logiciel) & " : " & vbCrLf
        ...
        Try
            ...
            Infos_diagnostic = Infos_diagnostic & vbCrLf & "  " & Message_utilisateur(108, Argument.langue_logiciel) & " : """ & Argument.Adresse_Serveur & """; Statut : " & Reply.Status.ToString & vbCrLf

        Catch ex As Exception
            'Ping du Serveur distant
            Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(108, Argument.langue_logiciel) & " : """ & Argument.Adresse_Serveur & " : """ & Argument.Adresse_Serveur & """ " + ex.Message & vbCrLf & vbCrLf
        ...
        'Recherche en cours
        Infos_diagnostic = Infos_diagnostic & vbCrLf & vbCrLf & " Tracert " & Message_utilisateur(109, Argument.langue_logiciel) & "..."
        ...
        Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(110, Argument.langue_logiciel) & " : """ & ConnStr & """ " & vbCrLf
        Diagnostique_Partie2 = vbCrLf & " " & Message_utilisateur(110, Argument.langue_logiciel) & " : """ & ConnStr & """ " & vbCrLf
        'MsgBox(ConnStr)
        'UCase()
        ...
        Try
            ...
            Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(111, Argument.langue_logiciel)
            Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & Message_utilisateur(111, Argument.langue_logiciel)

            'Requête
            Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : select version();" & vbCrLf
            Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : select version();" & vbCrLf
            ...
            Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(112, Argument.langue_logiciel)
            Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(112, Argument.langue_logiciel)
            Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & "  : SHOW FULL PROCESSLIST;" & vbCrLf
            Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : SHOW FULL PROCESSLIST;" & vbCrLf
            ...
            Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""SHOW DATABASES;"" "
            Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""SHOW DATABASES;"" "
            ...
            'Base(s) présente(nt)
            Infos_diagnostic = Infos_diagnostic & vbCrLf & vbCrLf & " " & Message_utilisateur(114, Argument.langue_logiciel) & " : " & vbCrLf & vbCrLf
            Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & vbCrLf & " " & Message_utilisateur(114, Argument.langue_logiciel) & " : " & vbCrLf & vbCrLf
            ...
            For x = 1 To 1000
                ...
                If (Base_Name_tableau = Argument.Nom_de_la_base_de_donnée) Then

                    'Dim Retour = (MsgBox("La base  : """ & Nom_de_la_base & """ Existe Bien. Etes vous sûr de vouloir la recréer?", MsgBoxStyle.YesNo, "Attention !"))
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(10, Argument.langue_logiciel) & " """ & Argument.Nom_de_la_base_de_donnée & """ " & Message_utilisateur(115, Argument.langue_logiciel) & "." & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(10, Argument.langue_logiciel) & " """ & Argument.Nom_de_la_base_de_donnée & """ " & Message_utilisateur(115, Argument.langue_logiciel) & "." & vbCrLf
                    pas_de_base = False
                    ...
                    conn5.Open()
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".TABLE_A;"""   'menu_verrouillage
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".TABLE_A;"""   'menu_verrouillage
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'TABLE_A'(menu_verrouillage) : " & nbre_enr5 & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'TABLE_A'(menu_verrouillage) : " & nbre_enr5 & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    conn5.Close()
                    ...
                    conn2.Open()
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".TABLE_B;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".TABLE_B;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'TABLE_B'(menu_audio_video) : " & nbre_enr2 & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'TABLE_B'(menu_audio_video) : " & nbre_enr2 & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    conn2.Close()
                    ...
                    conn1.Open()
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".TABLE_C;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".TABLE_C;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'TABLE_C' : " & nbre_enr & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'TABLE_C' : " & nbre_enr & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    conn1.Close()
                    ...
                    conn4.Open()
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".TABLE_D;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".TABLE_D;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'TABLE_D' : " & nbre_enr4 & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'TABLE_D' : " & nbre_enr4 & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    conn4.Close()
                    ...
                    conn3.Open()
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".TABLE_E;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".TABLE_E;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'TABLE_E' : " & nbre_enr3 & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'TABLE_E' : " & nbre_enr3 & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    conn3.Close()
                    ...
                    conn6.Open()
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".niveau_acces;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".niveau_acces;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'niveau_acces' : " & nbre_enr6 & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'niveau_acces' : " & nbre_enr6 & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    conn6.Close()
                    ...
                    conn19042009.Open()
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".enregistrements;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".enregistrements;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'enregistrements' : " & nbre_enr19042009 & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'enregistrements' : " & nbre_enr19042009 & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    conn19042009.Close()
                    ...
                    conn7.Open()
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".schema;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".schema;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'schema' : " & nbre_enr7 & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'schema' : " & nbre_enr7 & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf & vbCrLf
                    conn7.Close()
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'CONSTRUCTEURS' : " & nbre_enr8 & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'CONSTRUCTEURS' : " & nbre_enr8 & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf & vbCrLf
                    conn8.Close()
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'types_documents' : " & nbre_enr100508_d & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'types_documents' : " & nbre_enr100508_d & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf & vbCrLf
                    conn100508_d.Close()
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'doc_url' : " & nbre_enr310508_d & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'doc_url' : " & nbre_enr310508_d & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf & vbCrLf
                    conn310508_d.Close()
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'categories' : " & nbre_enr14062008_d & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'categories' : " & nbre_enr14062008_d & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'ref_constructeurs' : " & nbre_enr20062008_d & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'ref_constructeurs' : " & nbre_enr20062008_d & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".TABLE_XAML;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".TABLE_XAML;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'TABLE_XAML' : " & nbre_enr_19_02_2009_d & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'TABLE_XAML' : " & nbre_enr_19_02_2009_d & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".messages_utilisateur;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".messages_utilisateur;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'messages_utilisateur' : " & nbre_enr_17_04_2009_d & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'messages_utilisateur' : " & nbre_enr_17_04_2009_d & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".chrono_idref;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".chrono_idref;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'chrono_idref' : " & nbre_enr_17_05_2009a & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'chrono_idref' : " & nbre_enr_17_05_2009a & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".documents;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".documents;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'documents' : " & nbre_enr_06_06_2009a & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'documents' : " & nbre_enr_06_06_2009a & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".elements_winform;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".elements_winform;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'elements_winform' : " & nbre_enr_11_07_2009a & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'elements_winform' : " & nbre_enr_11_07_2009a & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".racine_zero;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".racine_zero;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'racine_zero' : " & nbre_enr_13_05_2010e & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'racine_zero' : " & nbre_enr_13_05_2010e & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`racine1`;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`racine1`;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'racine1' : " & nbre_enr_13_05_2010f & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'racine1' : " & nbre_enr_13_05_2010f & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`racine2`;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`racine2`;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'racine2' : " & nbre_enr_13_05_2010g & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'racine2' : " & nbre_enr_13_05_2010g & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`racine3`;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`racine3`;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'racine3' : " & nbre_enr_13_05_2010h & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'racine3' : " & nbre_enr_13_05_2010h & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`racine4`;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`racine4`;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'racine4' : " & nbre_enr_13_05_2010i & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'racine4' : " & nbre_enr_13_05_2010i & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`racine5`;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`racine5`;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'racine5' : " & nbre_enr_13_05_2010j & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'racine5' : " & nbre_enr_13_05_2010j & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`racine6`;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`racine6`;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'racine6' : " & nbre_enr_13_05_2010k & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'racine6' : " & nbre_enr_13_05_2010k & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`racine7`;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`racine7`;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'racine7' : " & nbre_enr_13_05_2010l & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'racine7' : " & nbre_enr_13_05_2010l & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`racine8`;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`racine8`;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'racine8' : " & nbre_enr_13_05_2010m & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'racine8' : " & nbre_enr_13_05_2010m & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`racine9`;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`racine9`;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'racine9' : " & nbre_enr_13_05_2010n & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'racine9' : " & nbre_enr_13_05_2010n & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`elements_HTML`;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`elements_HTML`;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'elements_HTML' : " & nbre_enr_20_08_2010a & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'elements_HTML' : " & nbre_enr_20_08_2010a & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`HISTORY_EVENTS`;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`HISTORY_EVENTS`;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'HISTORY_EVENTS' : " & nbre_enr_20_08_2010b & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'HISTORY_EVENTS' : " & nbre_enr_20_08_2010b & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`Users`;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`Users`;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'Users' : " & nbre_enr_20_08_2010c & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf & vbCrLf & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'Users' : " & nbre_enr_20_08_2010c & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`Questions`;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`Questions`;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'Questions' : " & nbre_enr_05_09_2010a & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf & vbCrLf & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'Questions' : " & nbre_enr_05_09_2010a & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`VERSIONS_TABLES`;"""
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""select count(*) from " & Argument.Nom_de_la_base_de_donnée & ".`VERSIONS_TABLES`;"""
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & "  -> Table 'VERSIONS_TABLES' : " & nbre_enr_30_04_2011a & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf & vbCrLf & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & "  -> Table 'VERSIONS_TABLES' : " & nbre_enr_30_04_2011a & " " & Message_utilisateur(116, Argument.langue_logiciel) & vbCrLf & vbCrLf & vbCrLf
                    ...
                    conn13.Open()
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".TABLE_A;""" & vbCrLf  'menu_verrouillage
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".TABLE_A;""" & vbCrLf  'menu_verrouillage
                    ...
                    conn10.Open()
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".TABLE_B;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".TABLE_B;""" & vbCrLf
                    ...
                    conn9.Open()
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".TABLE_C;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".TABLE_C;""" & vbCrLf
                    ...
                    conn12.Open()
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".TABLE_D;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".TABLE_D;""" & vbCrLf
                    ...
                    conn11.Open()
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".TABLE_E;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".TABLE_E;""" & vbCrLf
                    ...
                    conn14.Open()
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".niveau_acces;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".niveau_acces;""" & vbCrLf
                    ...
                    conn19042009a.Open()
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".enregistrements;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".enregistrements;""" & vbCrLf
                    ...
                    conn15.Open()
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".schema;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".schema;""" & vbCrLf
                    ...
                    conn16.Open()
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".CONSTRUCTEURS;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".CONSTRUCTEURS;""" & vbCrLf
                    ...
                    conn100508_e.Open()
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".types_documents;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".types_documents;""" & vbCrLf
                    ...
                    conn310508_e.Open()
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".doc_url;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".doc_url;""" & vbCrLf
                    ...
                    conn14062008_e.Open()
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".categories;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".categories;""" & vbCrLf
                    ...
                    conn20062008_e.Open()
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".ref_constructeurs;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".ref_constructeurs;""" & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".TABLE_XAML;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".TABLE_XAML;""" & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".messages_utilisateur;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".messages_utilisateur;""" & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".chrono_idref;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".chrono_idref;""" & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".documents;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".documents;""" & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".elements_winform;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".elements_winform;""" & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".racine_zero;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".racine_zero;""" & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`racine1`;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`racine1`;""" & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`racine2`;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`racine2`;""" & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`racine3`;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`racine3`;""" & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`racine4`;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`racine4`;""" & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`racine5`;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`racine5`;""" & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`racine6`;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`racine6`;""" & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`racine7`;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`racine7`;""" & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`racine8`;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`racine8`;""" & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`racine9`;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`racine9`;""" & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`elements_HTML`;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`elements_HTML`;""" & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`HISTORY_EVENTS`;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`HISTORY_EVENTS`;""" & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`Users`;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`Users`;""" & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`Questions`;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`Questions`;""" & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`VERSIONS_TABLES`;""" & vbCrLf
                    Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(113, Argument.langue_logiciel) & " : ""describe " & Argument.Nom_de_la_base_de_donnée & ".`VERSIONS_TABLES`;""" & vbCrLf
                    ...
                    Infos_diagnostic = Infos_diagnostic & vbCrLf & vbCrLf & _
                                         " " & Message_utilisateur(117, Argument.langue_logiciel) & "." & vbCrLf
            ...
            If (pas_de_base = True) Then
                ...
                Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(10, Argument.langue_logiciel) & " """ & Argument.Nom_de_la_base_de_donnée & """ " & Message_utilisateur(118, Argument.langue_logiciel) & "." & vbCrLf & " " & Message_utilisateur(119, Argument.langue_logiciel) & "." & vbCrLf & vbCrLf
                Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(10, Argument.langue_logiciel) & " """ & Argument.Nom_de_la_base_de_donnée & """ " & Message_utilisateur(118, Argument.langue_logiciel) & "." & vbCrLf & " " & Message_utilisateur(119, Argument.langue_logiciel) & "." & vbCrLf & vbCrLf

            End If

        Catch ex As MySqlException
            'Il y a eu une erreur
            Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(120, Argument.langue_logiciel) & " : " + ex.Message & vbCrLf
            Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(120, Argument.langue_logiciel) & " : " + ex.Message & vbCrLf
        ...
        Catch ey As System.ArgumentException
            'Il y a eu une erreur : 
            Infos_diagnostic = Infos_diagnostic & vbCrLf & " " & Message_utilisateur(120, Argument.langue_logiciel) & " : " + ey.Message & vbCrLf
            Diagnostique_Partie2 = Diagnostique_Partie2 & vbCrLf & " " & Message_utilisateur(120, Argument.langue_logiciel) & " : " + ey.Message & vbCrLf
    ...
    Private Sub Timer1_Tick(sender As System.Object, e As System.EventArgs) Handles Timer1.Tick
        ...
        If (My.Settings.Arret_Timer = True And Résultat_tracert.Length > 0) Then
            RichTextBox_Diagnostic.Text = Diagnostique_Partie1 & Résultat_tracert & Diagnostique_Partie2
            Timer1.Stop()
            Timer1.Dispose()
            My.Settings.ProgressBar_Diagnostic = 0
        End If
