Public Class logiciel_dessin
    ...
    MyBase.MouseDown
        ...
        If (OutilEnCours = 3) Then
            ...
            Indice_temporaire = Test_Coordonnées_pointeurs_avec_un_segement_Horizontale()
            ...
            Indice_temporaire = Test_Coordonnées_pointeurs_avec_un_segement_Oblique()
            If (Indice_temporaire > Indice_de_ligne_tracée_sur_écran And Indice_temporaire > 0) Then
                Indice_de_ligne_tracée_sur_écran_à_supprimer = 0
                Indice_temporaire = 0
            Else
...
label1:
            ...
            'MsgBox(Indice_de_ligne_tracée_sur_écran_à_supprimer)
            Question_Supprimer_Ligne = MessageBox.Show("Voulez vous supprimer cette Ligne?", "Supprimer une Ligne", MessageBoxButtons.YesNo, MessageBoxIcon.Question)

            If (Question_Supprimer_Ligne = Windows.Forms.DialogResult.Yes) Then
                Supprimer_une_Ligne_de_la_table_Ligne(Indice_de_ligne_tracée_sur_écran_à_supprimer)
            End If
    ...
    Public Function Supprimer_une_Ligne_de_la_table_Ligne(ByVal Position As Integer)
    ...
    Public Function Test_Coordonnées_pointeurs_avec_un_segement_Oblique()
        Dim T As Integer
        Dim U As Integer
        Dim V As Integer = 0
...
LABEL2:
    ...
    Public Function Test_Coordonnées_pointeurs_avec_un_segement_Horizontale()
        Dim T As Integer
        'MsgBox(Indice_de_ligne_tracée_sur_écran)
        For T = 1 To Indice_de_ligne_tracée_sur_écran + 1
