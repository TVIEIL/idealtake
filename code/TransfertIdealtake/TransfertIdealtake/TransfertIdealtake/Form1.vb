    ...
    Private Function RequêteSQLAjoutDocument(ByVal Chrono As String, ByVal ChaineDeConnexion As String, ByVal NomDeLaBaseDeDonnées As String, _
        ...
        Try
            ...
            If NouveauDocument.ImagePreview.Length > 0 Then
                ...
                'Si notre fichier preview doit être copié en local
                'e.g : c:\a\1\temp_v3_ImagePreview.jpg
                'IL faut protéger les \ en les doublants
                'la décision est prise si on détecte la chaîne :\ dans le chemin

                If (ChaineValeurImagePreview.Contains(":\") = True) Then
                    ChaineValeurImagePreview = ChaineValeurImagePreview.Replace("\", "\\")
